# DESG 260 Course Schedule — Winter 2026
...
- 🚩 = Major assignment (due to Learning Suite)
...
*Understandings:*
- Empathy, curiosity, and humility are essential for forming intent. These qualities help designers understand problems from perspectives beyond their own and resist the temptation to design for themselves.
- Research and testing are design activities, not separate phases. Understanding users, testing assumptions, and iterating based on feedback are central to the design process, not add-ons.
...
- Facilitate usability tests and synthesize findings (tests both the intent and its execution)
...
**Topics:**
- Big idea:
  - Discoverability & Feedback (basics of interaction design)
  - Design Thinking (Double diamond: discover, define, develop, deliver); Lean loop (Make, Measure, Learn); "wicked" problems; world building/storytelling
- Practical:
  - Usability Testing as a form of critique. What is a design critique?
  - Prep for next class: Expectations about Sketching, What is an Icon/Symbol?
  - Groups of four: game of Pictionary? Telephone Illustration game?

**Assignments:**
- ⛳ Write Letter to Prof. due
- ⛳ Sketches for Wayfinding Exercise due (in class)
- In-class testing of wayfinding exercise

**Activities:**

1. **Telestrations Game** (15 min)
   - Introduces feedback loop and communication breakdown
   - Connects to: How symbols communicate meaning — and how easily they can be misunderstood
   - Sets up the importance of testing your work with others

2. **A1 Sketch Review - Gallery Critique** (20 min)
   - Post all sketches on wall
   - Silent viewing period (5 min)
   - Dot voting: place dots on most communicative maps

3. **Partner Usability Test** (20 min)
   - Pairs trade sketches
   - Partner tries to "read" the journey without explanation
   - Record: What was clear? What was confusing?
   - Connects to: Research and testing as design activities

4. **Icon/Symbol Exercise: Pictionary or Telephone Illustration** (15 min)
   - Groups of 4
   - Practice communicating abstract concepts visually
   - Debrief: What made icons readable vs. confusing?

5. **Icon Sketching Workshop** (15 min)
   - Students identify 4-7 key moments in their journey
   - Quick sketches of potential icons (hand-drawn)
   - Emphasis on abstract emotions (assignment requirement)

6. **Introduce A2: Icon Set Draft** (15 min)
   - **A2 requirements:**
...
**Homework:** Complete A2 Icon Set Draft (2" tall, aligned, hand-drawn) — bring physical copies to Day 3
...
🇺🇸 **Dr. Martin Luther King, Jr. Day** — No classes, offices closed
...
### Friday, Apr 3 — ✝️ Good Friday
### Saturday, Apr 4 – Sunday, Apr 5 — **LDS General Conference**
### Sunday, Apr 5 — ✝️ Easter Sunday
...
### Reading Day — Thursday, Apr 16

**Resources:**
- Available for Process Book help
...
| Date | Event |
|------|-------|
| Friday, June 12 | Graphic Design & Product/UX BFA Applications DUE (likely) |
| Monday, June 15 | Final Day of Spring Term |
| Friday, June 19 | 🇺🇸 Juneteenth — Offices closed |
