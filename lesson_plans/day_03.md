...
- ⛳ A2 Icon Set Draft (bring physical copies to class)
...
5. **Introduce A3: Vectorized Icon Set** (10 min)
   - **A3 requirements:**
     ...
     - Consistent stroke weight and visual style across set
...
7. **Vectorizing Work Session** (80 min)
   ...
   - Focus feedback on: consistency, stroke weight, optical alignment, visual unity
...
8. **Wrap-Up: Progress Check** (10 min)
...
### Homework
Continue vectorizing icons; complete reading (Lupton Act 1 and "What is a Good Icon?") if not finished; bring vectorized icon set in progress to Day 4
...
- Tools reference: Shape tool, Pen tool, Pathfinder
