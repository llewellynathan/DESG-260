...
**Essential Questions:**
- EQ1: What is design?
- EQ2: What is the difference between forming intent and rendering intent—and why does good design require excellence in both?
- EQ3: What guiding principles help one to be a great designer?
- EQ4: How do symbols communicate meaning across language and culture?

**Understandings:**
- U1: Design is the forming and rendering of intent. Forming intent means discovering the right problem and envisioning the right solution. Rendering intent means executing that vision with skill and craft.
- U2: Even a focused project like icon design requires both forming intent (what must this icon communicate, to whom, in what context?) and rendering intent (how do I execute it with visual clarity and consistency?).

**Students Will Know:**
- K1: The distinction between forming intent (discovering the right problem and envisioning the right solution) and rendering intent (executing that vision skillfully)
- K2: The vocabulary and concepts of user experience design (affordances, signifiers, feedback, mental models, user flows)
- K3: What makes wayfinding systems succeed or fail

**Students Will Be Able To:**
- S1: Identify design problems worth solving through curiosity and empathy

**Targeted Learning Outcomes:** Critical Analysis of Form and Format, Better Interactions & Experiences
...
1. **Welcome & Introductions** (10 min)
   - Brief personal introductions (name, year, )

2. **Syllabus & Course Overview** (10 min) `[EQ2, U1, K1]`
   - Walk through four major projects (A-D) and how they build on each other
   - Point to syllabus for policies; don't read it aloud

3. **"What is Design?" Discussion** (15 min) `[EQ1, EQ2, K1, K2]`
   - Discuss with a neighbor: What is an experience?
   - Share with the class: What is an experience?
   - My definition: A period of time in which someone is conciously engaged with their surroundings.

   - Discuss with a neighbor: How do you define design? Turn to a neighbor and share.  Don't look up the definition, just give your own.
   - Share with the class: how do you define design?
   - My definition: Design is the forming and rendering of intent
      - Good design requires both good forming and good rendering
...
5. **Wayfinding/Experience Mapping Examples Gallery Walk** (15 min) `[EQ4, K3]`
   ...
   - **Discussion prompts for each example:**
     ...
     - What do the icons represent? (Concrete objects? Abstract emotions? Key moments?)
...
6. **Introduce Assignment 1: Wayfinding Map & Icons** (20 min) `[EQ2, U1, U2]`
   ...
   - Walk through full assignment (A1-A4) so students see the arc:
     - A1: Sketches (due Day 2)
     - A2: Icon Set Draft (due Day 3)
     - A3: Vectorized Icons (due Day 4)
     - A4: Final Process Book (due Day 5)
   - **Focus on A1 requirements:**
     - 5+ exploration thumbnails (distinct ideas, not variations)
     - 1 larger, more finessed sketch (at least 8.5 x 5.5)
     - Physical sketches to bring to class (printed if digital)
   - Clarify constraints: B&W, no existing icon sets, abstract emotions required
...
*(Instructor: curate 5-7 examples of journey/experience maps that include iconography)*

**Example Sources to Browse:**
- [Behance: Journey Maps](https://www.behance.net/search/projects/journey%20map)
- [Dribbble: Experience Maps](https://dribbble.com/search/experience-map)
- [Hero's Journey Graphics](https://theheroplace.com/elaborate-variations-of-the-classic-heros-journey-graphic/)
- [NN/g Journey Mapping 101](https://www.nngroup.com/articles/journey-mapping-101/)

**Additional Resources:**
- BYU campus building maps webpage
